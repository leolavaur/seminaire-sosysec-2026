...
\section[{\texttt{Assessment \& eiffel}}]{Assessing the Impact of Label-Flipping Attacks}
...
\begin{frame}{The Problem of Poisoning Attacks}
  ...
  \begin{figure}
    \centering
    \foreach \i in {1,...,7}{%
      \only<\i>{\hspace*{-1cm}\includegraphics[width=.8\textwidth,trim={0 1cm 0 1cm},clip]{figures/thesis/assessment/poisoning/\i.pdf}}%
    }
...
%   \begin{figure}
%     \centering
%     \includegraphics[width=.8\textwidth]{figures/thesis/assessment/accuracy_per_seed.pdf}
...
%   \begin{figure}
%     \centering
%     \includegraphics[width=\textwidth]{figures/thesis/assessment/hyperparams-late-icdcs.pdf}
