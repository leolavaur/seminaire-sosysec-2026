...
\begin{frame}{Information Security}
  ...
  \footcite*{nationalinstituteofstandardsandtechnology_NISTCybersecurityFramework_2024}
\end{frame}
...
\begin{frame}{Collaboration in Cybersecurity}
  \begin{columns}
    ...
    \begin{column}{.4\textwidth}
      \centering
      %\includegraphics<+>[width=\linewidth]{figures/thesis/intro/security-collab.drawio.pdf}%
...
\begin{frame}{Scaling Intrusion Detection}
  ...
  \begin{itemize}[<+->]
    \item Novel-\textit{ish} distributed ML paradigm (Google)~\autocite{mcmahan_Communicationefficientlearningdeep_2017}.
...
%     \only<2>{\footcite*{lavaur_icdcs_demo_2024}}
...
\begin{frame}{Case Study -- Generalization}
  \textbf{A cross-silo use case}~\footcite{kairouz_AdvancesOpenProblems_2021}:
  \begin{itemize}
...
\begin{frame}[b]{Contributions Summary}
  ...
  \vspace{-.8cm}
  \foreach \i in {1,...,9} {%
    \includegraphics<\i>[width=1.1\linewidth, center]{./figures/thesis/intro/metro/\i.pdf}%
  }
