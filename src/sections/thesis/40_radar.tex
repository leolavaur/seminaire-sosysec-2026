...
\section[\texttt{RADAR}]{Fighting Byzantine Contributions in Heterogeneous Settings}
...
%     \only<2->{\footcite*{briggs_Federatedlearninghierarchical_2020}}
%     \only<3->{\footcite*{chen_ZeroKnowledgeClustering_2021}}
% \end{frame}
...
%                 \includegraphics[width=\textwidth]{figures/thesis/radar/clustering.drawio.pdf}
%                 % \makebox[\textwidth][c]{%
%                 %   \includegraphics[width=1.2\textwidth]{figures/thesis/radar/clustering.drawio.pdf}%
%                 % }
%                 \caption{Hierarchical clustering.}
%             \end{figure}
%         \end{column}
          ...
          \begin{column}{.56\textwidth}
            \begin{figure}
              ...
              \caption*{
                ...
                \small (\ie, 2 attackers, 100\% DPR on Reconnaissance class).
              }
            \end{figure}
          \end{column}
      \end{columns}
...
\begin{frame}{Results}
  \begin{table}
    ...
    \begin{tabularx}{.5\textwidth}{lX|rrrr}
      ...
      \bottomrule % ---------------------------------
      \small & \multicolumn{1}{c}{} & \multicolumn{4}{c}{\textit{lower is better}}
    \end{tabularx}
  \end{table}
...
%   \begin{figure}
%     \centering
%     \includegraphics[width=.9\textwidth]{figures/thesis/radar/baselines.png}
%     \caption{Baseline comparison.}
%   \end{figure}
%   \begin{figure}
%     \centering
%     \includegraphics[width=.9\textwidth]{figures/thesis/radar/limiting-case.png}
