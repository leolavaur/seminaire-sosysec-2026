...
\begin{frame}{Contributions}
  \centering
  \vspace{-.3cm}
  \includegraphics[width=1.1\textwidth, center]{figures/thesis/intro/metro/10.pdf}%
...
\begin{frame}[b]{Perspectives: Going beyond FIDSs}
  ...
  \vspace{-.3cm}
  \foreach \i in {1,...,9} {%
    \includegraphics<\i>[width=1.1\textwidth, center]{figures/thesis/conclusion/perspectives/\i.pdf}%
  }%
\end{frame}
