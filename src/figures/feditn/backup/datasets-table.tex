...
\newcommand{\fnote}{\footnote{Some datasets do not have a recommended train/test split. In such cases, only the total number of records is provided.}}
...
\begin{minipage}{\textwidth}
  ...
  \begin{tabular}{lllllrrrr}
    \toprule
    Dataset      & Year &  Use case                   & Feature extraction      & Features    & Records (train/test)\fnote & Attack classes  & Reference \\ \midrule
